...
namespace Core.Managers
{
    ...
    public class PayrollManager
    {
        ...
        public bool AddEmployment(Employment employ)
        {
            ...
            using (var db = new WinxoContext()) if (db.Staffs.Find(employ.StaffGuid) == null) throw new InvalidOperationException("STAFF_REFERENCE_NOT_FOUND");
        ...
        public bool CancelSalary(Salary salary)
        {
            ...
            Employment emp;
            using (var db = new WinxoContext()) emp = db.Employments.Find(salary.EmploymentGuid);
