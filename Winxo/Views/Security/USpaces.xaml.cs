        ...
        public Guid ProfileGuid {
            set {
                new Task(() => Dispatcher.BeginInvoke(new Action(() => {
                    _profileGuid=value;
                    _ESPACES_LIST.ItemsSource=App.Winxo.Authentication.UserSpaces(_profileGuid);
                }))).Start();
            }
        ...
        private void IsInEspaceCheck_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            try {
                if(checkBox.IsChecked!=null)
                    App.Winxo.Authentication.SpaceClearance(((ViewCard)checkBox.DataContext).Info2.ToEnum<UserSpace>(), (bool)checkBox.IsChecked, _profileGuid);
