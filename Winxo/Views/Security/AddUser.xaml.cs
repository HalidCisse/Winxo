    ...
    internal partial class AddUser {
        ...
        public AddUser (Guid profileGuid) {
            ...
            new Task(() => {
                Dispatcher.BeginInvoke(new Action(() => {
                    ...
                    var membUser            = App.Winxo.Authentication.GetUser(profileGuid);
                    var theStaff            = App.Winxo.HumanResource.GetStaff(profileGuid);
                    ...
                    if(membUser==null) {
                        ...
                        var oldData = App.Winxo.Authentication.GetUser(profileGuid);
        ...
        private void save_Executed (object sender, ExecutedRoutedEventArgs e) {
            ...
            try {
                ...
                if (_isAdd)
                    status = App.Winxo.Authentication.AddUser(newData);
                else
                    App.Winxo.Authentication.UpdateUser(newData);
