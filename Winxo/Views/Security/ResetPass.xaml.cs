...
namespace Winxo.Views.Security
{
    ...
    internal partial class ResetPass {
        ...
        private void save_Executed (object sender, ExecutedRoutedEventArgs e) {
            string status;
            try {
                status=App.Winxo.Authentication.ResetPassword(_LOGIN.Text.Trim(), _REPONSE.Text);
        ...
        private void _LOGIN_OnLostFocus(object sender, RoutedEventArgs e) => _QUESTION.Content = App.Winxo.Authentication.GetUserQuestion(_LOGIN.Text.Trim());
